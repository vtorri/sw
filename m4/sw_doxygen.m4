...
dnl SW_CHECK_DOXYGEN([ACTION-IF-FOUND [, ACTION-IF-NOT-FOUND]])
dnl Test for the doxygen program
dnl Defines DOXYGEN
dnl Defines the automake conditionnal SW_BUILD_DOC
dnl
AC_DEFUN([SW_CHECK_DOXYGEN],
[
...
AM_CONDITIONAL(SW_BUILD_DOC, test "x${BUILD_DOCS}" = "xyes")
